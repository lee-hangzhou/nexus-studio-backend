...
from app.chat.conversation_title import (
...
from app.chat.memory.turn_input import build_turn_human_message
from app.chat.prompt.composer import PromptComposer
from app.chat.prompt.types import AttachmentBrief, TurnPromptContext
...
from app.chat.tools.result import BROWSER_BLOCKED, ToolResult as _ToolResult
...
from app.chat.turn.context import build_turn_context
from app.chat.turn.empty_recovery import recover_empty_answer
from app.chat.turn.gate_emit import emit_user_gates, has_pending_user_gate
from app.chat.gate.pending import clear_gate_pending
from app.chat.gate import turn_auth as turn_auth_store
from app.chat.turn.guards import TurnGuards
from app.chat.turn.lifecycle import clear_turn_active, mark_turn_active, touch_conversation_updated
...
from app.chat.turn.persistence import (
    TurnPersistence,
    finalize_assistant,
...
from app.chat.turn.usage_log import TerminatedBy, TurnUsageCollector
from app.chat.turn.usage_finalize import finalize_observation_segment
from app.chat.vision.gate import assert_vision_turn_allowed, is_image_mime
