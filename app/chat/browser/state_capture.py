...
from app.chat.browser import container_client, inprocess_session, runtime, session_manager
from app.chat.browser.debug_capture import (
    debug_capture_path,
    is_allowed_debug_capture_path,
    prune_debug_captures,
)
from app.chat.browser.session_lock import session_page_lock
from app.chat.tools.result import BROWSER_ERROR, INVALID_ARGUMENTS, ToolResult
from app.chat.workspace import resolve_workspace_file
