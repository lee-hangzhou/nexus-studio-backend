...
from app.agent.chat.tools.judgment_gate import JUDGMENT_TOOL_NAMES
...
def sanitize_tool_step_preview(tool_name: str, preview: str, *, ok: bool | None = None) -> str:
    ...
    if tool_name in JUDGMENT_TOOL_NAMES:
        return "已完成意图判断" if resolved_ok is not False else "意图判断未完成"
