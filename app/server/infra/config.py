...
class Settings(BaseSettings):
    ...
    CHAT_WORKSPACE_ROOT: str = Field(default="/tmp/nexus-studio-chat-workspaces")
    CHAT_SANDBOX_IMAGE: str = Field(default="nexus-studio-chat-sandbox:latest")
    CHAT_SANDBOX_TIMEOUT_SEC: int = Field(default=180)
    CHAT_SANDBOX_PACKAGES_ROOT: str = Field(default="/tmp/nexus-studio-sandbox-packages")
    ...
    CHAT_BROWSER_IMAGE: str = Field(default="nexus-studio-browser-session:latest")
