...
_CAPABILITY_TOOL_NAMES: dict[WorkshopToolCapability, tuple[str, ...]] = {
    ...
    WorkshopToolCapability.START_WORKFLOW_EXECUTION: ("start_workflow_execution",),
    WorkshopToolCapability.STOP_WORKFLOW_EXECUTION: ("stop_workflow_execution",),
    WorkshopToolCapability.DELETE_WORKFLOW: ("delete_workflow",),
