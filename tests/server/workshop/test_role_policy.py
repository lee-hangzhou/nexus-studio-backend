...
def test_host_is_pure_scheduler() -> None:
    ...
    assert role_allows(WorkshopRole.HOST, WorkshopToolCapability.START_WORKFLOW_EXECUTION)
    assert role_allows(WorkshopRole.HOST, WorkshopToolCapability.STOP_WORKFLOW_EXECUTION)
    assert role_allows(WorkshopRole.HOST, WorkshopToolCapability.DELETE_WORKFLOW)
